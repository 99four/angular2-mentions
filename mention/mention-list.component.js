...
var MentionListComponent = (function () {
    ...
    Object.defineProperty(MentionListComponent.prototype, "activeItem", {
        get: function () {
            ...
            return activeItem.name ? mention_utils_1.camelize(activeItem.name) : activeItem.email;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MentionListComponent.prototype, "activeItemId", {
        get: function () {
...
MentionListComponent = __decorate([
    core_1.Component({
        ...
        template: "\n    <ul class=\"dropdown-menu scrollable-menu\" #list [hidden]=\"hidden\">\n        <li *ngFor=\"let item of items; let i = index\" [class.active]=\"activeIndex==i\">\n          <a class=\"dropdown-item\" (mousedown)=\"activeIndex=i;itemClick.emit();$event.preventDefault()\"><b *ngIf=\"item.name !== item.email\">{{ item.name }}</b> {{item.email }}</a>\n        </li>\n    </ul>\n    "
    }),
